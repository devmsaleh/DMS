...
public class UIUtils {
     ...
     * @return
     */
    public static SelectOneMenu createSelectOneMenu(String symbolicName, Map<String, String> map, boolean addEmptyChoiceAtFirst) {
        ...
        selectOneMenu.getAttributes()
            .put(InputsDataTypes.DATA_TYPE_ATTRIBUTE_NAME, InputsDataTypes.CHOICE_LIST);
     ...
     **/
    public static void generatePropertiesInputs(List<Property> properties, HtmlPanelGrid propertiesPanelGrid, Locale locale, String operationName, User currentUser) throws Exception {
        ...
        for (Property property : properties) {
            ...
            if (property.getType()
                .equals(PropertyTypeEnum.SMALL_TEXT.getValue())
                || property.getType()
                    .equals(PropertyTypeEnum.GREG_DATE.getValue())
                || property.getType()
                    .equals(PropertyTypeEnum.HIJRI_DATE.getValue())
                || property.getType()
                    .equals(PropertyTypeEnum.SMALL_NUMBER.getValue())
                || property.getType()
                    .equals(PropertyTypeEnum.LONG_NUMBER.getValue())) {
                ...
                if (property.getType()
                    ...
                    if (property.getType()
                        .equals(PropertyTypeEnum.HIJRI_DATE.getValue())) {
                        if (!searchDocuments) {
                            inputText.getAttributes()
                                .put(InputsDataTypes.DATA_TYPE_ATTRIBUTE_NAME, InputsDataTypes.HIJRI_DATE);
                            inputText.setStyleClass(InputsStyles.HIJRI_DATE_STYLE_CLASS);
                            // inputText.setReadonly(true);
                        } else {
                            propertiesPanelGrid.getChildren()
                                .add(createHijriDateSearchInputs(property));
                        }
                    }
                    ...
                    if (property.getType()
                        ...
                        if (!searchDocuments) {
                            inputText.getAttributes()
                                .put(InputsDataTypes.DATA_TYPE_ATTRIBUTE_NAME, InputsDataTypes.GREG_DATE);
                            inputText.setStyleClass(InputsStyles.GREG_DATE_STYLE_CLASS);
                            // inputText.setReadonly(true);
                        } else {
                            propertiesPanelGrid.getChildren()
                                .add(createGregDateSearchInputs(property));
                        }
                    }
                    ...
                    if (property.getType()
                        .equals(PropertyTypeEnum.SMALL_NUMBER.getValue()))
                        inputText.getAttributes()
                            .put(InputsDataTypes.DATA_TYPE_ATTRIBUTE_NAME, InputsDataTypes.INTEGER);
                    else if (property.getType()
                        .equals(PropertyTypeEnum.LONG_NUMBER.getValue()))
                        inputText.getAttributes()
                            .put(InputsDataTypes.DATA_TYPE_ATTRIBUTE_NAME, InputsDataTypes.LONG);
                    else
                        inputText.getAttributes()
                            .put(InputsDataTypes.DATA_TYPE_ATTRIBUTE_NAME, InputsDataTypes.STRING);
                }

                uiInput = inputText;
                if (((searchDocuments) && (property.getType()
                    .equals(PropertyTypeEnum.GREG_DATE.getValue())
                    || property.getType()
                        .equals(PropertyTypeEnum.HIJRI_DATE.getValue())))
                    || makeUIInputNull) {
            ...
            if (property.getType()
                .equals(PropertyTypeEnum.NORMAL_CHOICELIST.getValue())
                || property.getType()
                    .equals(PropertyTypeEnum.MAIN_CHOICELIST.getValue())
                || property.getType()
                    .equals(PropertyTypeEnum.SUB_CHOICELIST.getValue())) {
                if (property.getType()
                    .equals(PropertyTypeEnum.MAIN_CHOICELIST.getValue())
                    || property.getType()
                        .equals(PropertyTypeEnum.NORMAL_CHOICELIST.getValue())) {
            ...
            if (uiInput != null) {
                ...
                uiInput.getAttributes()
                    .put("title", label.getValue());
                propertiesPanelGrid.getChildren()
                    .add(uiInput);
            }
    ...
    private static void setTabIndexForPropertiesInputs(HtmlPanelGrid propertiesPanelGrid) {
        ...
        for (UIComponent uIComponent : propertiesPanelGrid.getChildren()) {
            if (uIComponent instanceof HtmlInputText || uIComponent instanceof HtmlInputTextarea || uIComponent instanceof SelectOneMenu || uIComponent instanceof HtmlPanelGroup) {
                tabIndex++;
    ...
    private static void disableAllPropertiesInputs(HtmlPanelGrid propertiesPanelGrid) {
        ...
        for (UIComponent uIComponent : propertiesPanelGrid.getChildren()) {
            if (uIComponent instanceof HtmlInputText || uIComponent instanceof HtmlInputTextarea || uIComponent instanceof SelectOneMenu) {
    ...
    private static void addIntegrationBlurListener(Property property, UIInput uiInput, HtmlPanelGrid propertiesPanelGrid, String documentClassName, List<String> propertiesToSelect, String parentDocumentClassName) {
    ...
    public static IntegerConverter createIntegerConverter() {
        FacesContext context = FacesContext.getCurrentInstance();
        Application application = context.getApplication();
        IntegerConverter integerConverter = (IntegerConverter) application.createConverter(IntegerConverter.CONVERTER_ID);
     ...
     * @return
     */
    public static SelectOneMenu createSelectOneMenu(Property property, boolean addEmptyFirstItem, List<Property> properties, HtmlPanelGrid propertiesPanelGrid) {
        ...
        try {
            ...
            selectOneMenu.setFilter(true);
            selectOneMenu.setFilterMatchMode("contains");
            List<SelectItem> selectItems = new ArrayList<SelectItem>(property.getChoiceListItemsList()
                .size());
     ...
     * @return
     */
    public static SelectOneMenu updateSelectOneMenuItems(SelectOneMenu selectOneMenu, Map<String, String> selectItemsMap, boolean addEmptyFirstItem) {
        ...
        if (addEmptyFirstItem) {
            ...
            selectOneMenu.getAttributes()
                .put(InputsDataTypes.SELECT_MENU_NO_EMPTY_FIRST_ITEM_ATTR, true);
        }
    ...
    public static UIComponent getComponentByIdPart(String componentIdPart, List<UIComponent> components) {
        ...
        for (UIComponent component : components) {
            if (component.getId()
                .toLowerCase()
                .contains(componentIdPart.toLowerCase()))
                return component;
        }
    ...
    public static void clearUIInput(UIComponent uiComponent) {
        ...
        if (uiComponent instanceof UIInput) {
            ...
            if (input.getAttributes()
                .get(InputsDataTypes.SELECT_MENU_NO_EMPTY_FIRST_ITEM_ATTR) != null) {
     ...
     * @throws Exception
     */
    public static Map<String, Object> getPropertiesInputsValues(HtmlPanelGrid propertiesPanelGrid, String documentClassName, String documentId) throws Exception {
    ...
    private static void getPropertyNameAndValueFromUIInput(UIComponent uiComponent, String documentClassName, String documentId, Map<String, Object> propertiesMap) {
        ...
        if (input.getValue() != null && !input.getValue()
            .toString()
            .trim()
            .equals("")) {
        ...
        if (input.getAttributes()
            .get(InputsDataTypes.DATA_TYPE_ATTRIBUTE_NAME) != null) {
            dataType = input.getAttributes()
                .get(InputsDataTypes.DATA_TYPE_ATTRIBUTE_NAME)
                .toString()
                .trim();
        }

        if (valueObj != null) {
            if (StringUtils.isNotBlank(dataType) && (dataType.equalsIgnoreCase(InputsDataTypes.HIJRI_DATE) || dataType.equalsIgnoreCase(InputsDataTypes.GREG_DATE))) {
     ...
     * @return
     */
    public static List<String> generateHijriDateSearchWhereStatements(UIPanel panel, List<String> WhereStatements, List<Property> propertiesList) {

        return generateHijriDateSearchWhereStatements(panel, WhereStatements, null, null, propertiesList);

    }

    public static List<String> generateGregDateSearchWhereStatements(UIPanel panel, List<String> WhereStatements, List<Property> propertiesList) {
     ...
     * @return
     */
    public static List<String> generateHijriDateSearchWhereStatements(UIPanel panel, List<String> WhereStatements, List<SearchCriteria> criteras, String documentClassName, List<Property> propertiesList) {
        ...
        for (UIComponent searchComponenet : panel.getChildren()) {
            ...
            if (searchComponenet instanceof UIInput) {
                ...
                if (input.getValue() != null && StringUtils.isNotBlank(input.getValue()
                    .toString())) {
                    atLeastOneDateWasEntered = true;
                    int date = Integer.parseInt(input.getValue()
                        .toString()
                        .replaceAll("/", ""));
                    if (input.getId()
                        .contains(Constants.HIJRI_DATE_SEARCH_INPUT_FROM_CONTAINS)) {
                        fromValue = input.getValue()
                            .toString();
                        propertyName = input.getId()
                            .replaceAll(Constants.HIJRI_DATE_SEARCH_INPUT_FROM_CONTAINS, "");
                        propertyName = getColumnName(propertyName, propertiesList);
                        whereStatement = SearchService.constructIntWhere(propertyName, SearchService.GREATER_THAN_OR_EQUAL_CONDITION_KEYWORD, date);
                        WhereStatements.add(whereStatement);
                    } else if (input.getId()
                        .contains(Constants.HIJRI_DATE_SEARCH_INPUT_TO_CONTAINS)) {
                        toValue = input.getValue()
                            .toString();
                        propertyName = input.getId()
                            .replaceAll(Constants.HIJRI_DATE_SEARCH_INPUT_TO_CONTAINS, "");
                        propertyName = getColumnName(propertyName, propertiesList);
                        whereStatement = SearchService.constructIntWhere(propertyName, SearchService.LESS_THAN_OR_EQUAL_CONDITION_KEYWORD, date);
                        WhereStatements.add(whereStatement);
                    }
                }
    ...
    public static List<String> generateGregDateSearchWhereStatements(UIPanel panel, List<String> WhereStatements, List<SearchCriteria> criteras, String documentClassName, List<Property> propertiesList) {
            ...
            if (searchComponenet instanceof UIInput) {
                ...
                if (input.getValue() != null && StringUtils.isNotBlank(input.getValue()
                    ...
                    int date = Integer.parseInt(input.getValue()
                        ...
                        .replaceAll("/", ""));
                    if (input.getId()
                        .contains(Constants.GREG_DATE_SEARCH_INPUT_FROM_CONTAINS)) {
                        fromValue = input.getValue()
                            .toString();
                        propertyName = input.getId()
                            .replaceAll(Constants.GREG_DATE_SEARCH_INPUT_FROM_CONTAINS, "");
                        propertyName = getColumnName(propertyName, propertiesList);
                        whereStatement = SearchService.constructIntWhere(propertyName, SearchService.GREATER_THAN_OR_EQUAL_CONDITION_KEYWORD, date);
                        WhereStatements.add(whereStatement);
                    } else if (input.getId()
                        .contains(Constants.GREG_DATE_SEARCH_INPUT_TO_CONTAINS)) {
                        toValue = input.getValue()
                            .toString();
                        propertyName = input.getId()
                            .replaceAll(Constants.GREG_DATE_SEARCH_INPUT_TO_CONTAINS, "");
                        propertyName = getColumnName(propertyName, propertiesList);
                        whereStatement = SearchService.constructIntWhere(propertyName, SearchService.LESS_THAN_OR_EQUAL_CONDITION_KEYWORD, date);
                        WhereStatements.add(whereStatement);
                    }
     ...
     * @return
     */
    public static List<String> generateHijriDateSearchWhereStatementsDB(UIPanel panel, List<String> WhereStatements, List<SearchCriteria> criteras, String documentClassName, Map<String, String> propsColumnNames) {

        return WhereStatements;

    }

    public static List<String> generateGregDateSearchWhereStatementsDB(UIPanel panel, List<String> WhereStatements, List<SearchCriteria> criteras, String documentClassName, Map<String, String> propsColumnNames) {
            ...
            if (searchComponenet instanceof UIInput) {
                ...
                if (input.getValue() != null && StringUtils.isNotBlank(input.getValue()
                    ...
                    if (input.getId()
                        ...
                        whereStatement = SearchService.constructIntWhere(columnName, SearchService.GREATER_THAN_OR_EQUAL_CONDITION_KEYWORD, date);
                        WhereStatements.add(whereStatement);
                    } else if (input.getId()
                        .contains(Constants.GREG_DATE_SEARCH_INPUT_TO_CONTAINS)) {
                        toValue = input.getValue()
                        ...
                        propertySymbolicName = input.getId()
                            .replaceAll(Constants.GREG_DATE_SEARCH_INPUT_TO_CONTAINS, "");
                        columnName = propsColumnNames.get(propertySymbolicName);
                        whereStatement = SearchService.constructIntWhere(columnName, SearchService.LESS_THAN_OR_EQUAL_CONDITION_KEYWORD, date);
                        WhereStatements.add(whereStatement);
                    }
                }
     ...
     * @return
     */
    public static List<String> prepareSeachProperties(HtmlPanelGrid propertiesPanelGrid, List<Property> propertiesList) {
        ...
        for (UIComponent uiComponent : propertiesPanelGrid.getChildren()) {
            ...
            if (uiComponent instanceof UIInput) {
                ...
                if (id.toLowerCase()
                    .contains(Constants.HIJRI_DATE_SEARCH_DIV_CONTAINS.toLowerCase())) {
                    generateHijriDateSearchWhereStatements(htmlPanelGroup, propertiesWhereStatementsList, propertiesList);
                } else if (id.toLowerCase()
                    .contains(Constants.GREG_DATE_SEARCH_DIV_CONTAINS.toLowerCase())) {
                    generateGregDateSearchWhereStatements(htmlPanelGroup, propertiesWhereStatementsList, propertiesList);
                }
    ...
    public static void processUIComponentForSearch(UIComponent uiComponent, List<String> propertiesWhereStatementsList, List<Property> propertiesList) {
        ...
        if (StringUtils.isBlank(dataType)) {
            if (input.getClass()
                .getSimpleName()
                .equalsIgnoreCase(SelectOneMenu.class.getSimpleName())) {
    ...
    public static void processCustomSearchInputs(UIComponent uiComponent, List<UIComponent> uIComponents, List<String> propertiesWhereStatementsList) {
