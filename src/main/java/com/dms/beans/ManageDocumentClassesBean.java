...
public class ManageDocumentClassesBean implements Serializable {
    ...
    public void init() {
        try {
            ...
            if (choiceLists.size() > 0) {
                selectedChoiceListId = choiceLists.get(0)
                    .getId();
                propertyChoiceListId = choiceLists.get(0)
                    .getId();
                choiceListChanged();
            }
        } catch (Exception e) {
    ...
    public void createNewDocumentClass() {
        try {
            ...
            if (documentClassRepository.countByDisplayNameArabicIgnoreCase(newDocumentClass.getDisplayNameArabic()) > 0) {
    ...
    public void createNewChoiceList() {
        try {
            ...
            newChoiceList.setDisplayNameArabic(newChoiceList.getDisplayNameArabic()
                .trim());
    ...
    public void createNewItem() {
        try {
            ...
            if (StringUtils.isNotBlank(newItemName)) {
                ...
                selectedChoiceList.getItemsList()
                    .add(choiceListItem);
    ...
    private void doCreateNewProperty() {
        ...
        utilsRepository.createNewDocumentColumn(DocumentClassTableNameEnum.DEFAULT_TABLE.getValue(), newProperty.getColumnName(), newProperty.getColumnDatabaseType());
